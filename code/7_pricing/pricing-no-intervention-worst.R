...
#### WORST CASE
i_discount <- i_discount |> mutate(rate = rate * 0.2)
...
## lifetable
LT_SPWL_F_NS <- read_excel("data/base-life-tables.xlsx", sheet = "SPWL_Female_NS")
LT_SPWL_F_S <- read_excel("data/base-life-tables.xlsx", sheet = "SPWL_Female_S")
LT_SPWL_M_NS <- read_excel("data/base-life-tables.xlsx", sheet = "SPWL_Male_NS")
LT_SPWL_M_S <- read_excel("data/base-life-tables.xlsx", sheet = "SPWL_Male_S")
LT_T20_F_NS <- read_excel("data/base-life-tables.xlsx", sheet = "T20_Female_NS")
LT_T20_F_S <- read_excel("data/base-life-tables.xlsx", sheet = "T20_Female_S")
LT_T20_M_NS <- read_excel("data/base-life-tables.xlsx", sheet = "T20_Male_NS")
LT_T20_M_S <- read_excel("data/base-life-tables.xlsx", sheet = "T20_Male_S")
...
techprem_perdb <- expand.grid(issue_year = min(PH_existing$Issue.year):max(PH_future$Issue.year),
  ...
  write_csv("data/techprem_perdb_worst.csv")
### 2 minutes
...
# LT_T20_M_NS
# LT_T20_M_S
for (i in c("LT_T20_F_NS", "LT_T20_F_S", "LT_T20_M_NS", "LT_T20_M_S")) {
  name <- i # CHANGE
  print(paste("doing", i))
  ...
  mdt |> write_csv(paste0("data/mdt", "_", name, "_worst.csv"))
}
...
# LT_SPWL_M_NS
# LT_SPWL_M_S
for (i in c("LT_SPWL_F_NS", "LT_SPWL_F_S", "LT_SPWL_M_NS", "LT_SPWL_M_S")) {
  name <- i # CHANGE
  print(paste("doing", i))
  death_table <- get(name) |> select(age, qx)
  mdt <- tibble(
...
# MAIN (no intervention) --------------------------------------------------------------------

techprem_perdb <- read_csv("data/techprem_perdb.csv")
mdt_LT_SPWL_F_NS <- read_csv("data/mdt_LT_SPWL_F_NS.csv")
mdt_LT_SPWL_F_S <- read_csv("data/mdt_LT_SPWL_F_S.csv")
mdt_LT_SPWL_M_NS <- read_csv("data/mdt_LT_SPWL_M_NS.csv")
mdt_LT_SPWL_M_S <- read_csv("data/mdt_LT_SPWL_M_S.csv")
mdt_LT_T20_F_NS <- read_csv("data/mdt_LT_T20_F_NS.csv")
mdt_LT_T20_F_S <- read_csv("data/mdt_LT_T20_F_S.csv")
mdt_LT_T20_M_NS <- read_csv("data/mdt_LT_T20_M_NS.csv")
mdt_LT_T20_M_S <- read_csv("data/mdt_LT_T20_M_S.csv")
...
for (i in min(PH_future$Issue.year):max(PH_future$Issue.year)) {
  ...
  scored_existing <- PH_existing |> 
    ...
    mutate(inforce_nume = case_when(
      ...
      lifetable=="LT_SPWL_F_S" ~ mdt_LT_SPWL_F_S[match(now_age, mdt_LT_SPWL_F_S$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_NS" ~ mdt_LT_SPWL_M_NS[match(now_age, mdt_LT_SPWL_M_NS$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_S" ~ mdt_LT_SPWL_M_S[match(now_age, mdt_LT_SPWL_M_S$age), ] |> pull(lx),
      lifetable=="LT_T20_F_NS" ~ mdt_LT_T20_F_NS[match(now_age, mdt_LT_T20_F_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_F_S" ~ mdt_LT_T20_F_S[match(now_age, mdt_LT_T20_F_S$age), ] |> pull(lx),
      lifetable=="LT_T20_M_NS" ~ mdt_LT_T20_M_NS[match(now_age, mdt_LT_T20_M_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_M_S" ~ mdt_LT_T20_M_S[match(now_age, mdt_LT_T20_M_S$age), ] |> pull(lx),
      .default = NA
    )) |> 
    mutate(inforce_deno = case_when(
      lifetable=="LT_SPWL_F_NS" ~ mdt_LT_SPWL_F_NS[match(Issue.age, mdt_LT_SPWL_F_NS$age), ] |> pull(lx),
      lifetable=="LT_SPWL_F_S" ~ mdt_LT_SPWL_F_S[match(Issue.age, mdt_LT_SPWL_F_S$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_NS" ~ mdt_LT_SPWL_M_NS[match(Issue.age, mdt_LT_SPWL_M_NS$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_S" ~ mdt_LT_SPWL_M_S[match(Issue.age, mdt_LT_SPWL_M_S$age), ] |> pull(lx),
      lifetable=="LT_T20_F_NS" ~ mdt_LT_T20_F_NS[match(Issue.age, mdt_LT_T20_F_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_F_S" ~ mdt_LT_T20_F_S[match(Issue.age, mdt_LT_T20_F_S$age), ] |> pull(lx),
      lifetable=="LT_T20_M_NS" ~ mdt_LT_T20_M_NS[match(Issue.age, mdt_LT_T20_M_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_M_S" ~ mdt_LT_T20_M_S[match(Issue.age, mdt_LT_T20_M_S$age), ] |> pull(lx),
      .default = NA
    )) |> 
    ...
    mutate(inforce_nume_m1 = case_when(
      ...
      lifetable=="LT_SPWL_F_S" ~ mdt_LT_SPWL_F_S[match(ifelse(now_age-1 < 35, 35, now_age-1), mdt_LT_SPWL_F_S$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_NS" ~ mdt_LT_SPWL_M_NS[match(ifelse(now_age-1 < 35, 35, now_age-1), mdt_LT_SPWL_M_NS$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_S" ~ mdt_LT_SPWL_M_S[match(ifelse(now_age-1 < 35, 35, now_age-1), mdt_LT_SPWL_M_S$age), ] |> pull(lx),
      lifetable=="LT_T20_F_NS" ~ mdt_LT_T20_F_NS[match(ifelse(now_age-1 < 26, 26, now_age-1), mdt_LT_T20_F_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_F_S" ~ mdt_LT_T20_F_S[match(ifelse(now_age-1 < 26, 26, now_age-1), mdt_LT_T20_F_S$age), ] |> pull(lx),
      lifetable=="LT_T20_M_NS" ~ mdt_LT_T20_M_NS[match(ifelse(now_age-1 < 26, 26, now_age-1), mdt_LT_T20_M_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_M_S" ~ mdt_LT_T20_M_S[match(ifelse(now_age-1 < 26, 26, now_age-1), mdt_LT_T20_M_S$age), ] |> pull(lx),
      .default = NA
    )) |> 
    mutate(inforce_deno_m1 = case_when(
      ...
      lifetable=="LT_SPWL_F_S" ~ mdt_LT_SPWL_F_S[match(ifelse(Issue.age-1 < 35, 35, Issue.age-1), mdt_LT_SPWL_F_S$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_NS" ~ mdt_LT_SPWL_M_NS[match(ifelse(Issue.age-1 < 35, 35, Issue.age-1), mdt_LT_SPWL_M_NS$age), ] |> pull(lx),
      lifetable=="LT_SPWL_M_S" ~ mdt_LT_SPWL_M_S[match(ifelse(Issue.age-1 < 35, 35, Issue.age-1), mdt_LT_SPWL_M_S$age), ] |> pull(lx),
      lifetable=="LT_T20_F_NS" ~ mdt_LT_T20_F_NS[match(ifelse(Issue.age-1 < 26, 26, Issue.age-1), mdt_LT_T20_F_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_F_S" ~ mdt_LT_T20_F_S[match(ifelse(Issue.age-1 < 26, 26, Issue.age-1), mdt_LT_T20_F_S$age), ] |> pull(lx),
      lifetable=="LT_T20_M_NS" ~ mdt_LT_T20_M_NS[match(ifelse(Issue.age-1 < 26, 26, Issue.age-1), mdt_LT_T20_M_NS$age), ] |> pull(lx),
      lifetable=="LT_T20_M_S" ~ mdt_LT_T20_M_S[match(ifelse(Issue.age-1 < 26, 26, Issue.age-1), mdt_LT_T20_M_S$age), ] |> pull(lx),
      .default = NA
    )) |> 
    ...
    mutate(death = case_when(
      ...
      lifetable=="LT_SPWL_F_S" ~ mdt_LT_SPWL_F_S[match(now_age, mdt_LT_SPWL_F_S$age), ] |> pull(death),
      lifetable=="LT_SPWL_M_NS" ~ mdt_LT_SPWL_M_NS[match(now_age, mdt_LT_SPWL_M_NS$age), ] |> pull(death),
      lifetable=="LT_SPWL_M_S" ~ mdt_LT_SPWL_M_S[match(now_age, mdt_LT_SPWL_M_S$age), ] |> pull(death),
      lifetable=="LT_T20_F_NS" ~ mdt_LT_T20_F_NS[match(now_age, mdt_LT_T20_F_NS$age), ] |> pull(death),
      lifetable=="LT_T20_F_S" ~ mdt_LT_T20_F_S[match(now_age, mdt_LT_T20_F_S$age), ] |> pull(death),
      lifetable=="LT_T20_M_NS" ~ mdt_LT_T20_M_NS[match(now_age, mdt_LT_T20_M_NS$age), ] |> pull(death),
      lifetable=="LT_T20_M_S" ~ mdt_LT_T20_M_S[match(now_age, mdt_LT_T20_M_S$age), ] |> pull(death),
      .default = NA
    )) |> 
    ...
    left_join(techprem_perdb |> mutate(reserve_eop = techprem_perdb) |> filter(issue_year == year),
              by = join_by(Policy.type == policy_type,
                           now_age == issue_age,
                           Sex == sex,
                           Smoker.Status == smoker)) |> 
    select(-c(issue_year, lifetable.y, techprem_perdb.y)) |> 
    mutate(reserve_eop = case_when(
      Policy.type=="SPWL" ~ reserve_eop * Face.amount,
      Policy.type=="T20" & Smoker.Status=="S" ~ assumption_reserve_T20_S * Face.amount,
      Policy.type=="T20" & Smoker.Status=="NS" ~ assumption_reserve_T20_NS * Face.amount,
      .default = NA
    )) |> 
    # reserve last year (start of period)
    mutate(now_age_m1 = now_age - 1) |> 
    left_join(techprem_perdb |> mutate(reserve_sop = techprem_perdb) |> filter(issue_year == year - 1),
              by = join_by(Policy.type == policy_type,
                           now_age_m1 == issue_age,
                           Sex == sex,
                           Smoker.Status == smoker)) |> 
    select(-c(now_age_m1, issue_year, lifetable, techprem_perdb)) |> 
    mutate(reserve_sop = case_when(
      Policy.type=="SPWL" ~ reserve_sop * Face.amount,
      Policy.type=="T20" & Smoker.Status=="S" ~ assumption_reserve_T20_S * Face.amount,
      Policy.type=="T20" & Smoker.Status=="NS" ~ assumption_reserve_T20_NS * Face.amount,
      .default = NA
    )) |> 
  ...
  scored_existing |> 
    ...
    write_csv(paste0("data/", year, "ledger-no-intervention-worst.csv"))
}
